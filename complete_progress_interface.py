#!/usr/bin/env python3
"""
Script pour créer la version complète et finale du fichier progress_interface.py
"""
...
class RealTimeProgressInterface:
    ...
    async def track_operation(self, 
        ...
        # Convertir OperationType en string si nécessaire
...
print("Fichier progress_interface.py complet créé avec toutes les méthodes")